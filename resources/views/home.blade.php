    ...
    <x-content-section>
        ...
        <x-slot name="content">
            <p>
                ...
                committed
                and enthusiastic web developer with 17 years experience in web design and development, I am an
                enthusiast of
    ...
    <x-content-section>
        ...
        <x-slot name="content">
            ...
            <p>
                ...
                I
                am planning on looking into Laravel Livewire, and hopefully to start contributing to open source
                software more.
            </p>
            <p>
