<x-project-item
    ...
    <div class="flex flex-col">
        <div class="flex-1">
            ...
            <p>
                Below is a basic example of a Blueprint, the Blueprint is for a User Model and includes for plans for
                the users name, email, password and created at timestamp. The password and created at plans also have
                modifiers on them to hide it on the index view, and hide it on the form view respectively.
            </p>
            <p>
                Architect will use this Blueprint and render a tabular list of the users in the application and display
                their name, email and the date they were created, and then the and edit forms will render inputs for
