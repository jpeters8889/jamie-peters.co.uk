            ...
            <div class="flex flex-col">
                <div>
                    <p>
                        ...
                        normal table based layouts, then when I turned 15 and did my Work Experience through school I
                        started learning PHP and MySQL, when table layouts started dying out in the mid-to-late 2000s I
                        started learning CSS and making my first DIV based layouts, and since then I have always kept
                        learning.
                    </p>
                    <p>
                        ...
                        projects, and later within the last couple of years I started learning and using Laravel more,
                        which I have now become a bit of an enthusiast for, and I have also been using TDD with my
                        Laravel projects.
                    </p>
                    <p>
                        Coupled with learning Laravel I have also started using Tailwind CSS more instead of writing my
                        own traditional CSS files, and I have also learnt the Vue Javascript framework and started
                    ...
                    <p>
                        I also love to travel, which helps with my photography, I'm also a little bit of an adrenaline
                        junkie, I love Roller Coasters and thrill rides, along with my mother in law I completed the <a
                            href="https://www.zipworld.co.uk/adventure/velocity" target="_blank">Velocity 2</a> zip wire
                        at Penrhyn Quarry in North Wales, the fastest zipslide in the world at over 100mph, and the
                        longest in Europe, in the process we raised over £1,600 for the Critical Care Unit at Royal
                        Stoke Hospital after my father in law spent a considerable amount of time there following a
                        severe Stroke, I have also always wanted to do a bungee jump or skydive, but unfortunately I
                        have never had the opportunity... <strong>yet</strong>.
                    </p>
                    <p>
                        I am also a music lover, particularly rock and the punk/pop punk sub genres, I have been playing
